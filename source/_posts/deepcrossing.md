...
- [1. 动机](#1-动机)
- [2. 模型结构及原理](#2-模型结构及原理)
  - [2.1 Embedding Layer](#21-embedding-layer)
  - [2.2 Stacking Layer](#22-stacking-layer)
  - [2.3 Multiple Residual Units Layer](#23-multiple-residual-units-layer)
  - [2.4 Scoring Layer](#24-scoring-layer)
- [3.总结](#3总结)
- [4. 代码实现](#4-代码实现)
...
![deepcrossing模型](./deepcrossing/deepcrossing模型.png)
